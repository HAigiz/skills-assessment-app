...
('Python', 'Языки программирования', 'Объектно-ориентированный язык программирования'),
('JavaScript', 'Языки программирования', 'Язык программирования для веб-разработки'),
('SQL', 'Базы данных', 'Язык структурированных запросов'),
('Docker', 'DevOps', 'Платформа для контейнеризации приложений'),
('Git', 'Инструменты', 'Система контроля версий'),
('React', 'Фреймворки', 'JavaScript библиотека для создания UI'),
('Коммуникация', 'Soft Skills', 'Навыки эффективного общения'),
('Лидерство', 'Soft Skills', 'Умение вести команду за собой'),
('Решение проблем', 'Soft Skills', 'Аналитическое мышление и решение сложных задач');